...
try {
    ...
    $mail->Password   = 'mementoinception9354';                               // SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 587;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

    //Recipients
    $mail->setFrom($to, 'Mailer');
    $mail->addAddress('rakibphoto1997@gmail.com', 'Joe User');     // Add a recipient
   ...
   // $mail->addBCC('bcc@example.com');
    ...
    window.location.href= 'http://localhost/Job Portal/admin/apply_jobs.php';
