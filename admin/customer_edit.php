...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="#">Update Clients</a></li>
    
  </ol>
</nav>   
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
         <h1 class="h2">Update Clients</h1>
 <div class="btn-toolbar mb-2 mb-md-0">
        ...
        <!--     <a class= "btn btn-primary" hreh="add_customer.php">Add Customers </a> -->
         ...
         <select name="admin_type" name="admin_type" value ="<?php echo $admin_type;?>" id="admin_type">
...
$(document).ready(function(){
  $("#submit").click(function () {
          ...
          $.ajax({
            type:"POST",
         //   url:"Customer_add.php", //I commented this
            data:data,
...
if(isset($_POST['submit'])){
    ...
    if($query1){ //i changed this from query from query1
