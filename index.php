...
<div class="dropdown">
<img src="images/profile_1.jpg" class ="img circle dropdown-toggle" type = "button" data-toggle="dropdown" width = "50" height = "50" alt="">
...
if(isset($_POST['search'])){
  ...
  $sql=mysqli_query($conn,"select * from all_jobs LEFT JOIN company ON all_jobs.customer_email=company.admin WHERE 
            ...
            <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
              ...
              <div class="mb-4 mb-md-0 mr-5">
                ...
                <div class="job-post-item-body d-block d-md-flex">
                  ...
                  <div><span class="icon-my_location"></span> <span><?php echo $row['country']; ?>,
                   <?php echo $row['city']; ?>, <?php echo $row['state']; ?>                  </span></div>
                </div>
              </div>
